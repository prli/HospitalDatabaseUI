		...
		<div id="list-visitation_record" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="diagnosis" title="${message(code: 'visitation_record.prescription.label', default: 'prescription')}" />
						
						<g:sortableColumn property="diagnosis" title="${message(code: 'visitation_record.scheduleOfTreatment.label', default: 'scheduleOfTreatment')}" />
				...
				<g:each in="${visitation_recordInstanceList}" status="i" var="visitation_recordInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: visitation_recordInstance, field: "prescription")}</td>
						
						<td>${fieldValue(bean: visitation_recordInstance, field: "scheduleOfTreatment")}</td>
